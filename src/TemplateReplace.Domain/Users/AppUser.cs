...
namespace TemplateReplace.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TemplateReplaceDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TemplateReplaceEfCoreEntityExtensionMappings to extend the IdentityUser entity
